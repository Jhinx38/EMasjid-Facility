...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $sql = "UPDATE ITCOM SET MOSQUEID=?, I_FULLNAME=?, I_EMAIL=?, I_TELNUM=?, PASSWORD=? WHERE ITCOMID=?";
	if($stmt = mysqli_prepare($conn, $sql)){
        // Bind variables to the prepared statement as parameters
        mysqli_stmt_bind_param($stmt, "ssssss", $mosqueid, $fullname, $email, $contactnum, $password, $itcomid);
    ...
    if(isset($_GET["itcomid"]) && !empty(trim($_GET["itcomid"]))){
        // Get URL parameter
        $itcomid =  trim($_GET["itcomid"]);
        
        // Prepare a select statement
        $sql = "SELECT I.*, MOSQUENAME, I.MOSQUEID FROM ITCOM I, MOSQUE M WHERE I.MOSQUEID = M.MOSQUEID AND ITCOMID = ?";
        if($stmt = mysqli_prepare($conn, $sql)){

            // Bind variables to the prepared statement as parameters
            mysqli_stmt_bind_param($stmt, "i", $itcomid);
...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Update IT Committee Details</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="index-admin.php">Home</a></li>
          <li class="breadcrumb-item"><a href="admin-itcomm-list.php">Back</a></li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section">
        <div class="card">
            <div class="card-body" action="" method="POST">
              ...
              <p>
                IT Committee ID: <input type="text" name="itcomid" value="<?php echo $itcomid; ?>" readonly>
              </p>
                <div class="col-md-4">
                    <label for="validationCustom01" class="form-label">Full Name</label>
                    <input type="text" class="form-control" name="fullname" value="<?php echo $fullname; ?>" requied>
                </div>
                <div class="col-md-4">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control" name="password" value="<?php echo $passwordd ?>" required>
                </div>
                <div class="col-12">
