...
<body>
    ...
    <div class="search-bar">
      <form class="search-form d-flex align-items-center" method="POST" action="">
        <input type="text" name="searchData" placeholder="Enter mosque name.." title="Enter mosque name..">
          ...
          <div class="card">
            <div class="card-body">
              ...
              if(!isset($_POST['btnSearch'])){
                $sql = "SELECT COMPLAINTID, STATUS_NAME, U_FULLNAME, ITEM_NAME, MOSQUENAME, DETAILS FROM COMPLAINT C, USER U, STATUS S, ITEM I, MOSQUE M WHERE (C.USERID = U.USERID AND C.STATUS_ID = S.STATUS_ID) AND (C.ITEM_ID = I.ITEM_ID AND C.MOSQUEID = M.MOSQUEID)";
                    ...
                    echo "<table class='table'>";
                      ...
                      while($row = mysqli_fetch_array($result)){
                          echo "<tr>";
                            ...
                            echo "<td>";
                              echo '<a href="admin-update-complaint.php?complaintid=' . $row['COMPLAINTID'] . '">
                              <i class="bi bi-pen-fill"></i>
                                <span>Update</span>
                              </a>';
                              echo " ";
                              echo '<a href="admin-delete-complaint.php?complaintid=' . $row['COMPLAINTID'] . '">
              ...
              elseif(isset($_POST['btnSearch'])){
                if(empty(trim($_POST['searchData']))){
                  ...
                  $sql = "SELECT COMPLAINTID, STATUS_NAME, U_FULLNAME, ITEM_NAME, MOSQUENAME, DETAILS FROM COMPLAINT C, USER U, STATUS S, ITEM I, MOSQUE M WHERE ((C.USERID = U.USERID AND C.STATUS_ID = S.STATUS_ID) AND (C.ITEM_ID = I.ITEM_ID AND C.MOSQUEID = M.MOSQUEID)) AND MOSQUENAME LIKE '%$data%'";
                  $result = mysqli_query($conn, $sql);
                  if(mysqli_num_rows($result) > 0){
                    echo "<table class='table'>";
                      echo "<thead>";
