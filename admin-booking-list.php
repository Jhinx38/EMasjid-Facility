          ...
          <div class="card">
            <div class="card-body">
              ...
              if(!isset($_POST['btnSearch'])){
                $sql = "SELECT BOOKINGID, STATUS_NAME, U_FULLNAME, ITEM_NAME, MOSQUENAME FROM BOOKING B, USER U, STATUS S, ITEM I, MOSQUE M WHERE (B.USERID = U.USERID AND B.STATUS_ID = S.STATUS_ID) AND (B.ITEM_ID = I.ITEM_ID AND B.MOSQUEID = M.MOSQUEID)";
                    ...
                    echo "<table class='table'>";
                      ...
                      while($row = mysqli_fetch_array($result)){
                          echo "<tr>";
                            ...
                            echo "<td>";
                              echo '<a href="admin-update-booking.php?bookingid=' . $row['BOOKINGID'] . '">
                              <i class="bi bi-pen-fill"></i>
                                <span>Update</span>
                              </a>';
                              echo " ";
                              echo '<a href="admin-delete-booking.php?bookingid=' . $row['BOOKINGID'] . '">
              ...
              elseif(isset($_POST['btnSearch'])){
                if(empty(trim($_POST['searchData']))){
                  ...
                  $sql = "SELECT BOOKINGID, STATUS_NAME, U_FULLNAME, ITEM_NAME, MOSQUENAME FROM BOOKING B, USER U, STATUS S, ITEM I, MOSQUE M WHERE ((B.USERID = U.USERID AND B.STATUS_ID = S.STATUS_ID) AND (B.ITEM_ID = I.ITEM_ID AND B.MOSQUEID = M.MOSQUEID)) AND MOSQUENAME LIKE '%$data%'";
                  $result = mysqli_query($conn, $sql);
                  if(mysqli_num_rows($result) > 0){
                    echo "<table class='table'>";
                      echo "<thead>";
