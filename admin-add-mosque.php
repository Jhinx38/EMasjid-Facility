...
<body>
    ...
    <main id="main" class="main">
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="card-title">Add Masjid Form:</h5>
                ...
                <form class="row g-3" method="post" action="formengine.php" enctype="multipart/form-data">
                    <div class="col-md-6">
                        <div class="form-floating">
                            <input type="text" name="mosqueName" class="form-control" placeholder="">
                            <label for="floatingName" autocapitalize="on">Mosque Name</label>
                        </div>
                    </div>
                    ...
                    <div class="text-center">
                        ...
                        <button type="submit" name="admin-add-mosque" class="btn btn-primary">Submit</button>
