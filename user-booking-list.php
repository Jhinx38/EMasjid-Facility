          ...
          <div class="card">
            <div class="card-body">
              ...
              if (!isset($_POST['btnSearch'])) {
                $sql = "SELECT BOOKINGID, STATUS_NAME, ITEM_NAME, SDATE, EDATE, MOSQUENAME FROM BOOKING B, STATUS S, ITEM T, USER U, MOSQUE M WHERE ((B.STATUS_ID = S.STATUS_ID AND B.MOSQUEID = M.MOSQUEID) AND (B.ITEM_ID = T.ITEM_ID AND B.USERID = U.USERID)) AND U_FULLNAME LIKE '$name'";
                  ...
                  if (mysqli_num_rows($result) > 0) {
                    ...
                    while ($row = mysqli_fetch_array($result)) {
                      ...
                      if ($row['STATUS_NAME'] != "Approved") {
                        echo '<a href="user-update-booking.php?bookingid=' . $row['BOOKINGID'] . '">
                      ...
                      echo " ";
                      echo '<a href="user-delete-booking.php?bookingid=' . $row['BOOKINGID'] . '">
                ...
                if (empty(trim($_POST['searchData']))) {
                  ...
                  $sql = "SELECT BOOKINGID, STATUS_NAME, ITEM_NAME, SDATE, EDATE, MOSQUENAME FROM BOOKING B, STATUS S, ITEM T, USER U, MOSQUE M WHERE (((B.STATUS_ID = S.STATUS_ID AND B.MOSQUEID = M.MOSQUEID) AND (B.ITEM_ID = T.ITEM_ID AND B.USERID = U.USERID)) AND U_FULLNAME LIKE '$name') AND STATUS_NAME LIKE '$data'";
                  $result = mysqli_query($conn, $sql);
                  if (mysqli_num_rows($result) > 0) {
                    echo "<table class='table'>";
                    echo "<thead>";
