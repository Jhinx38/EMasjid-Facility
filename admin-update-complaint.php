...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $sql = "UPDATE COMPLAINT SET USERID=?, MOSQUEID=?, STATUS_ID=?, ITEM_ID=?, DETAILS=?, DATE=? WHERE COMPLAINTID=?";
	  if($stmt = mysqli_prepare($conn, $sql)){
        ...
        if(mysqli_stmt_execute($stmt)){
            ...
            header("location: admin-complaint-list.php");
            exit();
        }
        else{
    ...
    if(isset($_GET["complaintid"]) && !empty(trim($_GET["complaintid"]))){
        ...
        $sql = "SELECT C.USERID, U_FULLNAME, C.MOSQUEID, MOSQUENAME, ITEM_NAME, C.ITEM_ID, DETAILS, DATE, STATUS_NAME, C.STATUS_ID FROM COMPLAINT C, ITEM I, USER U, MOSQUE M, STATUS S" . 
            ...
            <div class="card-body" action="" method="POST">
              ...
              <p>
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control" name="complaintid" value="<?php echo $complaintid; ?>" readonly>
                </div>
                <div class="col-md-4">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control" name="itemname" value="<?php echo $itemname; ?>" readonly>
                </div>
                <div class="col-md-4">
                  <label for="validationCustom02" class="form-label">Details</label>
                  <input type="text" class="form-control" name="details" value="<?php echo $details; ?>" readonly>
                </div>
                <div class="col-md-4">
                ...
                <div class="col-12">
                    <input type="hidden" class="form-control" name="mosqueid" value="<?php echo $mosqueid; ?>">
