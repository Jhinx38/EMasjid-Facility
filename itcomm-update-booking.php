...
if($_SERVER["REQUEST_METHOD"] == "POST"){
	...
	if($stmt = mysqli_prepare($conn, $sql)){
        ...
        if(mysqli_stmt_execute($stmt)){
            ...
            header("location: itcomm-booking-list.php");
            exit();
        }
        else{
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="itcomm-booking-list.php">Back</a></li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
            ...
            <div class="card-body" action="" method="POST">
              ...
              <p>
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control" name="bookingid" value="<?php echo $bookingid; ?>" readonly>
                </div>
                <div class="col-md-4">
