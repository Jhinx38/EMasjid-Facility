...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <a href="-itcomm.php" class="logo d-flex align-items-center"> <span class="d-none d-lg-block">Facility Management</span></a>
                ...
                <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                  ...
                  <form action="profileEngine.php" method="post">
                    ...
                    <div class="text-center">
                        ...
                        <input type="hidden" class="form-control" name="option" value="I">
