...
<body>
    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            <h1>E-Masjid Facility Management</h1>
            <nav>
                <ol class="breadcrumb">
          ...
          <div class="card info-card sales-card">
            ...
            <div class="card-body">
              ...
              <div class="d-flex align-items-center">
                ...
                <div class="ps-3">
                    <?php
                        $sql = "SELECT * FROM BOOKING WHERE MOSQUEID = '$mosqueid'";
                  ...
                  <span class="text-success small pt-1 fw-bold">Total Booking</span>
          ...
          <div class="card info-card revenue-card">
            <div class="card-body">
              ...
              <div class="d-flex align-items-center">
                ...
                <div class="ps-3">
                    <?php
                        $sql = "SELECT * FROM COMPLAINT WHERE MOSQUEID = '$mosqueid'";
                        $result = mysqli_query($conn, $sql);
                        $count = 0;
                        while($row = mysqli_fetch_array($result)){
                            $count++;
                    ...
                    ?>
                  <h6><?php echo $count; ?></h6>
                  <span class="text-success small pt-1 fw-bold">Total Complaint</span>
          ...
          <div class="card info-card customers-card">
            <div class="card-body">
              ...
              <div class="d-flex align-items-center">
                ...
                <div class="ps-3">
                    <?php
                        $sql = "SELECT * FROM ITCOM WHERE MOSQUEID = '$mosqueid'";
                        $result = mysqli_query($conn, $sql);
                        $count = 0;
                        while($row = mysqli_fetch_array($result)){
                            $count++;
                    ...
                    ?>
                  <h6><?php echo $count; ?></h6>
                  <span class="text-danger small pt-1 fw-bold">Total IT Committees</span>
