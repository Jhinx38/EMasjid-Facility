        ...
        <div class="card">
            <div class="card-body" action="" method="POST">
              ...
              <form class="row g-3 needs-validation" action="<?php echo htmlspecialchars(basename($_SERVER['REQUEST_URI'])); ?>" method="post" novalidate>
                <p>
                    IT Committee ID: <input type="text" name="itcomid" value="<?php echo $itcomid; ?>" disabled> 
                </p>
                <div class="col-md-4">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control" name="mosquename" value="<?php echo $mosquename; ?>" disabled>
                </div>
                <div class="col-md-4">
                ...
                <div class="col-12">
                    <input type="hidden" name="itcomid" value="<?php echo $itcomid; ?>">
