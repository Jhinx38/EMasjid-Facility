          ...
          <div class="card">
            <div class="card-body">
              ...
              if(!isset($_POST['btnSearch'])){
                $sql = "SELECT *, MOSQUENAME FROM ITCOM I, MOSQUE M WHERE I.MOSQUEID = M.MOSQUEID";
                    ...
                    echo "<table class='table'>";
                      ...
                      while($row = mysqli_fetch_array($result)){
                          echo "<tr>";
                            ...
                            echo "<td>" . $row['I_FULLNAME'] . "</td>";
                            echo "<td>" . $row['MOSQUENAME'] . "</td>";
                            echo "<td>" . $row['I_EMAIL'] . "</td>";
                            echo "<td>" . $row['I_TELNUM'] . "</td>";
                            echo "<td>" . $row['PASSWORD'] . "</td>";
                            echo "<td>";
                              echo '<a href="admin-update-itcomm.php?itcomid=' . $row['ITCOMID'] . '">
                              <i class="bi bi-pen-fill"></i>
                                <span>Update</span>
                              </a>';
                              echo " ";
                              echo '<a href="admin-delete-itcomm.php?itcomid=' . $row['ITCOMID'] . '">
              ...
              elseif(isset($_POST['btnSearch'])){
                if(empty(trim($_POST['searchData']))){
                  ...
                  $sql = "SELECT *, MOSQUENAME FROM ITCOM I, MOSQUE M WHERE I.MOSQUEID = M.MOSQUEID AND MOSQUENAME LIKE '%$data%'";
                  $result = mysqli_query($conn, $sql);
                  if(mysqli_num_rows($result) > 0){
                    echo "<table class='table'>";
                      echo "<thead>";
