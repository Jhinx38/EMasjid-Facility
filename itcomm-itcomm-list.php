  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="search-bar">
      <form class="search-form d-flex align-items-center" method="POST" action="">
        <input type="text" name="searchData" placeholder="Enter name.." title="Enter name..">
          ...
          <div class="card">
            <div class="card-body">
              ...
              if(!isset($_POST['btnSearch'])){
                $sql = "SELECT *, MOSQUENAME FROM ITCOM I, MOSQUE M WHERE I.MOSQUEID = M.MOSQUEID AND I.MOSQUEID = '$mosqueid'";
              ...
              elseif(isset($_POST['btnSearch'])){
                if(empty(trim($_POST['searchData']))){
                  ...
                  $sql = "SELECT *, MOSQUENAME FROM ITCOM I, MOSQUE M WHERE I.MOSQUEID = M.MOSQUEID AND I.MOSQUEID = '$mosqueid' AND I_FULLNAME LIKE '%$data%'";
                  $result = mysqli_query($conn, $sql);
                  if(mysqli_num_rows($result) > 0){
                    echo "<table class='table'>";
                      echo "<thead>";
