...
<div class="pagetitle">
    <h1>E-Masjid Complaint Facility Form</h1>
    <nav>
        <ol class="breadcrumb">
...
<div class="card">
    <div class="card-body">
        ...
        <form class="row g-3" method="post" action="formengine.php">
            ...
            <div class="col-md-12">
                <div class="form-floating">
                    <input type="text" class="form-control" id="floatingName" value="<?= $name ?>" disabled>
                    <input type="hidden" name="userid" value="<?= $userid ?>">
                    <label for="floatingName" autocapitalize="on">Your Name</label>
                </div>
            </div>

            <div class="col-md-6">
                <div class="form-floating">
                    <select class="form-select" name="mosqueid" aria-label="State">
                        <?php
                    ...
                    <label for="floatingEmail">Mosque</label>
                </div>
            </div>

            <div class="col-md-6">
                <div class="form-floating">
                    <select class="form-select" name="itemid" aria-label="State">
                        <?php
                    ...
                    <label for="floatingEmail">Item</label>
                </div>
            </div>

            <div class="col-12">
                <div class="form-floating">
                    <textarea class="form-control" name="details" placeholder="Address" style="height: 100px;"></textarea>
            ...
            <div class="col-md-2">
                <div class="form-floating mb-3">
                    ...
                    <label for="floatingSelect">Apply Date</label>
                </div>
            </div>

            <div class="text-center">
                <button type="submit" name="user-add-complaint" class="btn btn-primary">Submit</button>
